...
/* Custom hook for why choose us footer section */

<?php
function reasons_footer_hook() {
    do_action('reasons_footer_hook');
}
?>

<?php
add_action('reasons_footer_hook', 'reasons_footer_function');

function reasons_footer_function() {
	echo do_shortcode('[block id="874504"]');
}
?>

<?php reasons_footer_hook(); ?>
